...
extern int FreeBSD_GetPercMemUsedObjCmd( ClientData d, Tcl_Interp *i, int c, Tcl_Obj *const o[]);
...
extern int FreeBSD_GetNetStatObjCmd( ClientData d, Tcl_Interp *i, int c, Tcl_Obj *const o[]);
